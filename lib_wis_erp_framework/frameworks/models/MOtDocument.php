...
class MOtDocument extends MBaseModel
{
    private $cols = array(
                  ...
                  [ # 0 For insert, update, delete
                    ...
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_1:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_1:N',
                    'DEDUCTION_MINUTE_TOTAL_2:NZ:DEDUCTION_MINUTE_TOTAL_2:N',
                    'DEDUCTION_AMOUNT_2:NZ:DEDUCTION_AMOUNT_2:N',
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_2:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_2:N',
                    'DEDUCTION_MINUTE_TOTAL_3:NZ:DEDUCTION_MINUTE_TOTAL_3:N',
                    'DEDUCTION_AMOUNT_3:NZ:DEDUCTION_AMOUNT_3:N',
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_3:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_3:N',
                    'DEDUCTION_MINUTE_TOTAL_4:NZ:DEDUCTION_MINUTE_TOTAL_4:N',
                    'DEDUCTION_AMOUNT_4:NZ:DEDUCTION_AMOUNT_4:N',
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_4:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_4:N',
                    'DEDUCTION_MINUTE_TOTAL_5:NZ:DEDUCTION_MINUTE_TOTAL_5:N',
                    'DEDUCTION_AMOUNT_5:NZ:DEDUCTION_AMOUNT_5:N',
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_5:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_5:N',
                    'DEDUCTION_MINUTE_TOTAL_6:NZ:DEDUCTION_MINUTE_TOTAL_6:N',
                    'DEDUCTION_AMOUNT_6:NZ:DEDUCTION_AMOUNT_6:N',
                    'DEDUCTION_HOUR_ROUNDED_TOTAL_6:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_6:N',
                  ...
                  [ # 1 For Get List
                    ...
                    'OD.DEDUCTION_MINUTE_TOTAL_2:NZ:DEDUCTION_MINUTE_TOTAL_2:N',
                    'OD.DEDUCTION_AMOUNT_2:NZ:DEDUCTION_AMOUNT_2:N',
                    'OD.DEDUCTION_HOUR_ROUNDED_TOTAL_2:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_2:N',
                    'OD.DEDUCTION_MINUTE_TOTAL_3:NZ:DEDUCTION_MINUTE_TOTAL_3:N',
                    'OD.DEDUCTION_AMOUNT_3:NZ:DEDUCTION_AMOUNT_3:N',
                    'OD.DEDUCTION_HOUR_ROUNDED_TOTAL_3:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_3:N',
                    'OD.DEDUCTION_MINUTE_TOTAL_4:NZ:DEDUCTION_MINUTE_TOTAL_4:N',
                    'OD.DEDUCTION_AMOUNT_4:NZ:DEDUCTION_AMOUNT_4:N',
                    'OD.DEDUCTION_HOUR_ROUNDED_TOTAL_4:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_4:N',
                    'OD.DEDUCTION_MINUTE_TOTAL_5:NZ:DEDUCTION_MINUTE_TOTAL_5:N',
                    'OD.DEDUCTION_AMOUNT_5:NZ:DEDUCTION_AMOUNT_5:N',
                    'OD.DEDUCTION_HOUR_ROUNDED_TOTAL_5:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_5:N',
                    'OD.DEDUCTION_MINUTE_TOTAL_6:NZ:DEDUCTION_MINUTE_TOTAL_6:N',
                    'OD.DEDUCTION_AMOUNT_6:NZ:DEDUCTION_AMOUNT_6:N',
                    'OD.DEDUCTION_HOUR_ROUNDED_TOTAL_6:NZ:DEDUCTION_HOUR_ROUNDED_TOTAL_6:N',
