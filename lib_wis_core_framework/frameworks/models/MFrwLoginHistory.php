<?php
/* 
    Purpose : Model for FRAMEWORK_LOGIN_HISTORY
...
class MFrwLoginHistory extends MBaseModel
{
    private $cols = array(
    ...
    private $froms = array(
        'FROM FRW_LOGIN_HISTORY ',
        'FROM FRW_LOGIN_HISTORY LH',
        'FROM FRW_LOGIN_HISTORY ',
    );
    ...
    {
        parent::__construct($db, 'FRW_LOGIN_HISTORY', 'LOGIN_ID', $this->cols, $this->froms, $this->orderby);
    }
}
